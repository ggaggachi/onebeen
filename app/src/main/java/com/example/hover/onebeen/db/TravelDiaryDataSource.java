...
public class TravelDiaryDataSource {
    ...
    public Long insertTravelDiary(TravelDiary travelDiary) {
        ...
        values.put(TravelDiarySchema.BACKGROUND_IMAGE_COLUMN, travelDiary.getBackgroundImagePath());
    ...
    public List<TravelDiary> getTravelDiaries() {
        ...
        Cursor cursor = database.query(TravelDiarySchema.TABLE_NAME, null, PuzzleTableSchema.TRAVEL_ID, null, null, null, null);

        List<TravelDiary> travelDiaries = new ArrayList<>();
